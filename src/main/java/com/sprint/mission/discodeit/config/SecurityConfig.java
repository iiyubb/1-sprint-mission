...
public class SecurityConfig {
  ...
  SecurityFilterChain filterChain(
    ...
    http
        ...
        .csrf(csrf -> csrf.ignoringRequestMatchers(SecurityMatchers.LOGIN, SecurityMatchers.SIGN_UP,
  ...
  public PersistentTokenBasedRememberMeServices rememberMeServices(
      @Value("${SECURITY_REMEMBER_ME_KEY}") String key,
      @Value("${SECURITY_REMEMBER_ME_TOKEN_VALIDITY_SECONDS}") int tokenValiditySeconds,
